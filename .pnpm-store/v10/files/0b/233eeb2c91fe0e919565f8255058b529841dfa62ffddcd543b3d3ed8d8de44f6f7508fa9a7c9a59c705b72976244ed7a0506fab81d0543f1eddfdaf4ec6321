...
var require_scheduler_production_min = _chunkYTB6UVWKcjs.__commonJS.call(void 0, {
...
var require_scheduler_development = _chunkYTB6UVWKcjs.__commonJS.call(void 0, {
...
var require_scheduler = _chunkYTB6UVWKcjs.__commonJS.call(void 0, {
...
var require_react_reconciler_production_min = _chunkYTB6UVWKcjs.__commonJS.call(void 0, {
  "../../node_modules/.pnpm/react-reconciler@0.29.2_react@18.3.1/node_modules/react-reconciler/cjs/react-reconciler.production.min.js"(exports, module) {
    ...
    module.exports = function $$$reconciler($$$hostConfig) {
      var exports2 = {};
      "use strict";
      var aa = _chunkYTB6UVWKcjs.require_react.call(void 0, ), ba = require_scheduler(), ca = Object.assign;
      function n(a) {
...
var require_react_reconciler_development = _chunkYTB6UVWKcjs.__commonJS.call(void 0, {
  "../../node_modules/.pnpm/react-reconciler@0.29.2_react@18.3.1/node_modules/react-reconciler/cjs/react-reconciler.development.js"(exports, module) {
    ...
    if (process.env.NODE_ENV !== "production") {
      module.exports = function $$$reconciler($$$hostConfig) {
        var exports2 = {};
        "use strict";
        var React = _chunkYTB6UVWKcjs.require_react.call(void 0, );
...
var require_react_reconciler = _chunkYTB6UVWKcjs.__commonJS.call(void 0, {
...
var require_react_reconciler_constants_production_min = _chunkYTB6UVWKcjs.__commonJS.call(void 0, {
...
var require_react_reconciler_constants_development = _chunkYTB6UVWKcjs.__commonJS.call(void 0, {
...
var require_constants = _chunkYTB6UVWKcjs.__commonJS.call(void 0, {
...
var nodeNames = ["kubb-export", "kubb-file", "kubb-source", "kubb-import", "kubb-text", "kubb-parser"];

// src/shared/ReactTemplate.tsx
_chunkYTB6UVWKcjs.init_cjs_shims.call(void 0, );
...
var ErrorBoundary = class extends import_react.Component {
  ...
  componentDidCatch(error) {
    if (error) {
      ...
      _optionalChain([this, 'access', _ => _.props, 'access', _2 => _2.logger, 'optionalAccess', _3 => _3.emit, 'call', _4 => _4("error", error.message, error)]);
    }
  }
  render() {
...
var RootContext = (0, import_react.createContext)({
  meta: {}
});
function Root({ onError, logger, meta, children }) {
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ErrorBoundary, { logger, onError, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(RootContext.Provider, { value: { meta }, children }) });
}
Root.Context = RootContext;

// src/reconciler.ts
_chunkYTB6UVWKcjs.init_cjs_shims.call(void 0, );
var import_react_reconciler = _chunkYTB6UVWKcjs.__toESM.call(void 0, require_react_reconciler(), 1);
var import_constants = _chunkYTB6UVWKcjs.__toESM.call(void 0, require_constants(), 1);
...
// src/shared/utils/getFiles.ts
_chunkYTB6UVWKcjs.init_cjs_shims.call(void 0, );

// src/shared/utils/squashExportNodes.ts
_chunkYTB6UVWKcjs.init_cjs_shims.call(void 0, );
...
// src/shared/utils/squashImportNodes.ts
_chunkYTB6UVWKcjs.init_cjs_shims.call(void 0, );
...
// src/shared/utils/squashSourceNodes.ts
_chunkYTB6UVWKcjs.init_cjs_shims.call(void 0, );

// src/shared/utils/read.ts
_chunkYTB6UVWKcjs.init_cjs_shims.call(void 0, );
...
function read(text, node) {
  ...
  try {
    let source = text;
    if (attributes.path) {
      source = _fs.readSync.call(void 0, attributes.path);
    }
    return source;
  } catch (e) {
    console.log(e);
...
// src/shared/utils/squashSourceNodes.ts
function squashSourceNodes(node) {
  let text = "";
  for (let index = 0; index < node.childNodes.length; index++) {
    const childNode = node.childNodes[index];
    if (!childNode) {
...
// src/shared/utils/getFiles.ts
function getFiles(node, language) {
  let files = [];
  for (let index = 0; index < node.childNodes.length; index++) {
    const childNode = node.childNodes[index];
    if (!childNode) {
...
// src/shared/utils/squashTextNodes.ts
_chunkYTB6UVWKcjs.init_cjs_shims.call(void 0, );

var _parserts = require('@kubb/parser-ts');
var _factory = require('@kubb/parser-ts/factory'); var factory = _interopRequireWildcard(_factory);
function squashTextNodes(node) {
  ...
  for (let index = 0; index < node.childNodes.length; index++) {
    ...
    let nodeText = "";
    const getPrintText = (text2) => {
      if (childNode.nodeName === "kubb-import") {
        const attributes = childNode.attributes;
        return _parserts.print.call(void 0, 
          factory.createImportDeclaration({
            name: attributes.name,
            path: attributes.root ? _fs.getRelativePath.call(void 0, attributes.root, attributes.path) : attributes.path,
...
var _options, _isUnmounted, _lastOutput, _lastFiles, _container, _rootNode;
var ReactTemplate = class {
  constructor(rootNode, options = { debug: false }) {
    _chunkYTB6UVWKcjs.__privateAdd.call(void 0, this, _options);
    // Ignore last render after unmounting a tree to prevent empty output before exit
    _chunkYTB6UVWKcjs.__privateAdd.call(void 0, this, _isUnmounted);
    _chunkYTB6UVWKcjs.__privateAdd.call(void 0, this, _lastOutput);
    _chunkYTB6UVWKcjs.__privateAdd.call(void 0, this, _lastFiles, []);
    _chunkYTB6UVWKcjs.__privateAdd.call(void 0, this, _container);
    _chunkYTB6UVWKcjs.__privateAdd.call(void 0, this, _rootNode);
    this.id = _crypto2.default.randomUUID();
    this.resized = () => {
      this.onRender();
    };
    ...
    this.onRender = () => {
      if (_chunkYTB6UVWKcjs.__privateGet.call(void 0, this, _isUnmounted)) {
        return;
      }
      const { output, files } = renderer(_chunkYTB6UVWKcjs.__privateGet.call(void 0, this, _rootNode));
      _chunkYTB6UVWKcjs.__privateSet.call(void 0, this, _lastOutput, output);
      _chunkYTB6UVWKcjs.__privateSet.call(void 0, this, _lastFiles, files);
    };
    _chunkYTB6UVWKcjs.__privateSet.call(void 0, this, _options, options);
    if (options.logger) {
      this.logger = options.logger;
    }
    _chunkYTB6UVWKcjs.__privateSet.call(void 0, this, _rootNode, rootNode);
    _chunkYTB6UVWKcjs.__privateGet.call(void 0, this, _rootNode).onRender = options.debug ? this.onRender : throttle(this.onRender, 32)[0];
    _chunkYTB6UVWKcjs.__privateGet.call(void 0, this, _rootNode).onImmediateRender = this.onRender;
    _chunkYTB6UVWKcjs.__privateSet.call(void 0, this, _isUnmounted, false);
    _chunkYTB6UVWKcjs.__privateSet.call(void 0, this, _lastOutput, "");
    _chunkYTB6UVWKcjs.__privateSet.call(void 0, this, _container, reconciler.createContainer(
      _chunkYTB6UVWKcjs.__privateGet.call(void 0, this, _rootNode),
      // Legacy mode
      0,
      null,
      false,
    ...
    if (_process2.default.env["DEV"] === "true") {
  ...
  get output() {
    return _chunkYTB6UVWKcjs.__privateGet.call(void 0, this, _lastOutput);
  }
  get files() {
    return _chunkYTB6UVWKcjs.__privateGet.call(void 0, this, _lastFiles);
  }
  onError(error) {
  ...
  render(node, context) {
    if (context) {
      const element = /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(Root, { logger: this.logger, meta: context.meta, onError: this.onError, children: node });
      reconciler.updateContainer(element, _chunkYTB6UVWKcjs.__privateGet.call(void 0, this, _container), null, noop);
      return;
    }
    reconciler.updateContainer(node, _chunkYTB6UVWKcjs.__privateGet.call(void 0, this, _container), null, noop);
  }
  unmount(error) {
    if (_chunkYTB6UVWKcjs.__privateGet.call(void 0, this, _isUnmounted)) {
      return;
    ...
    this.onRender();
    this.unsubscribeExit();
    _chunkYTB6UVWKcjs.__privateSet.call(void 0, this, _isUnmounted, true);
    reconciler.updateContainer(null, _chunkYTB6UVWKcjs.__privateGet.call(void 0, this, _container), null, noop);
...
_isUnmounted = new WeakMap();
_lastOutput = new WeakMap();
_lastFiles = new WeakMap();
...
exports.createNode = createNode; exports.ReactTemplate = ReactTemplate;
...
react-reconciler/cjs/react-reconciler-constants.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-BNKXOCXZ.cjs.map