...
var ReactTemplate = class {
  constructor(rootNode, options = { debug: false }) {
    ...
    __privateAdd(this, _isUnmounted);
    __privateAdd(this, _lastOutput);
    __privateAdd(this, _lastFiles, []);
    ...
    this.onRender = () => {
      if (__privateGet(this, _isUnmounted)) {
        return;
      }
      const { output, files } = renderer(__privateGet(this, _rootNode));
      __privateSet(this, _lastOutput, output);
      __privateSet(this, _lastFiles, files);
    };
    ...
    __privateGet(this, _rootNode).onRender = options.debug ? this.onRender : throttle(this.onRender, 32)[0];
    __privateGet(this, _rootNode).onImmediateRender = this.onRender;
    __privateSet(this, _isUnmounted, false);
    __privateSet(this, _lastOutput, "");
    __privateSet(this, _container, reconciler.createContainer(
  ...
  get output() {
    return __privateGet(this, _lastOutput);
  }
  get files() {
    return __privateGet(this, _lastFiles);
  }
  onError(error) {
  ...
  render(node, context) {
    if (context) {
      ...
      reconciler.updateContainer(element, __privateGet(this, _container), null, noop);
      return;
    }
    reconciler.updateContainer(node, __privateGet(this, _container), null, noop);
  }
  unmount(error) {
    if (__privateGet(this, _isUnmounted)) {
      return;
    ...
    this.onRender();
    this.unsubscribeExit();
    __privateSet(this, _isUnmounted, true);
    reconciler.updateContainer(null, __privateGet(this, _container), null, noop);
...
react-reconciler/cjs/react-reconciler-constants.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-ZZLUX5JS.js.map