...
var _chunkDAS55TQFcjs = require('./chunk-DAS55TQF.cjs');
  ...
  operation(path, method, opts = {}) {
    ...
    if (opts.isWebhook) {
      ...
      if (_optionalChain([api, 'optionalAccess', _7 => _7.webhooks, 'access', _8 => _8[path], 'optionalAccess', _9 => _9[method]])) {
        ...
        return new (0, _chunkDAS55TQFcjs.Webhook)(api, path, method, operation);
      }
    }
    ...
    return new (0, _chunkDAS55TQFcjs.Operation)(this.api, path, method, operation);
  }
  ...
  async dereference(opts = { preserveRefAsJSONSchemaTitle: false }) {
    ...
    if (api && api.components && api.components.schemas && typeof api.components.schemas === "object") {
      Object.keys(api.components.schemas).forEach((schemaName) => {
        if (_chunkTG4VCYD4cjs.isPrimitive.call(void 0, api.components.schemas[schemaName]) || Array.isArray(api.components.schemas[schemaName]) || api.components.schemas[schemaName] === null) {
          return;
        }
...
exports.Oas = Oas;
//# sourceMappingURL=chunk-CPI37LBJ.cjs.map